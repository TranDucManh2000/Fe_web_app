  ...
  return (
    <TripWrapper>
      <div className="trip_container">
        ...
        <h1 style={{ marginTop: 50 }}>Road to Ha Giang</h1>
        <p>
          uê em là một ngôi làng nhỏ nằm dưới chân núi. Đứng ở lưng núi là có
          ...
          tốt được chăm sóc chu đáo. Là màu xanh của những ao bèo, hồ sen. Thật
          là thích mắt! Nhờ thảm xanh ấy và cả ngọn núi lớn mà cả làng lúc nào
          cũng mát mẻ. Cuộc sống nơi đây thì bình yên, chậm rãi. Em luôn cảm
          thấy quê mình như là một chốn thế ngoại đào viên cho mọi người dừng
          chân nghỉ ngơi khi đã mệt nhọc với chốn xô bồ ngoài kia.
        </p>
      </div>
    </TripWrapper>
  );
